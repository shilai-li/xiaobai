/**
 *******************************************************************************************************************************************
 * @file        dev_lcd_mpu_qspi_private.h
 ...
 *******************************************************************************************************************************************
 */
#ifndef __DEV_LCD_MPU_QSPI_PRIVATE_H__
#define __DEV_LCD_MPU_QSPI_PRIVATE_H__
...
#define __LCD_QSPI_SEQ_SET_WR(seq, ins, ins_line, addrs, addrline, addrbits, alt, alt_line, alt_bits, dummycycles, dataline, datacount) \
    __LCD_QSPI_SEQ_SET(seq, ins, ins_line, addrs, addrline, addrbits, alt, alt_line, alt_bits, dummycycles, dataline, datacount, 0)

#define __LCD_QSPI_SEQ_SET_RD(seq, ins, ins_line, addrs, addrline, addrbits, alt, alt_line, alt_bits, dummycycles, dataline, datacount) \
    __LCD_QSPI_SEQ_SET(seq, ins, ins_line, addrs, addrline, addrbits, alt, alt_line, alt_bits, dummycycles, dataline, datacount, 1)

#endif //__DEV_LCD_MPU_QSPI_PRIVATE_H__
