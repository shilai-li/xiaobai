...
struct AudioStreamPacket {
    ...
    // Local ESP32 monotonic timestamp used only for transport diagnostics.
    int64_t esp_timestamp_us = 0;
    int64_t mic_capture_time_us = 0;
    int64_t opus_encode_start_time_us = 0;
    int64_t opus_ready_time_us = 0;
    int64_t opus_encode_time_us = 0;
...
public:
    ...
    virtual bool IsAuthenticationError() const { return false; }
